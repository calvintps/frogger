...
var baseObject = function ( obj, x, y, w, h) {
  ...
  //doesX is a function
  function doesSomething (a,b,c) {
    console.log('the closure has access to : Outer function paramenters', h);
    console.log('the closure has access to : Outer function variables', specialVariable);
    console.log('the closure has access to : It own parameter', a);

    console.log(a, obj.x , h);
...
var closureExample = baseObject( {}, 1,2,3,4);
//closureExample.doesSomething('a','b','c');
